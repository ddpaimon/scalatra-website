...
<div class="alert alert-info">
  ...
  See
  <a href="https://github.com/scalatra/scalatra-website-examples/tree/master/2.5/formats/scalatra-commands">scalatra-commands</a>
...
```scala
"org.scalatra" %% "scalatra-commands" % "{{< 2-5-scalatra_version >}}",
```
